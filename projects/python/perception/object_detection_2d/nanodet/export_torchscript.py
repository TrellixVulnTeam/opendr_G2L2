...
if __name__ == '__main__':
    ...
    # If you want to have a specific ratio in your dataset, first read an openDR image from your dataset and run:
    img = Image.open("./predefined_examples/000000000036.jpg")
    nanodet.export_torchscript("./torchscript_m.pth", img)
